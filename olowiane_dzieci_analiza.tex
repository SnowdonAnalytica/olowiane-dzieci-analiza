...
%
%  SCREENSHOT PROTOCOL:
%  - The user supplies passages as screenshots of running text.
%  - Screenshots often begin or end mid-sentence. Analyse ONLY
%    complete sentences (opening capital AND closing period both
%    visible). Ignore fragments at start (already covered) and
%    end (will be covered next). Ask for the next screenshot
