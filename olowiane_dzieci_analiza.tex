...
%  2. Read grammar.tex to understand the grammatical framework
%     established so far.
%  3. Read the most recent active chapter file to see where
%     the reading left off.
%  4. The user will supply the next passage as a screenshot.
%     Continue the phrase-by-phrase analysis in the same style.
%  5. When enough new material has accumulated, offer to update
%     the relevant chapter .tex file.
%  6. Maintain the tone of the existing analyses: informative,
...
\newcommand{\poltext}[1]{%
  \vspace{0.5em}
  {\color{polishblue}\large\itshape #1}%
  \vspace{0.3em}\par
}

% \poltrans{} — English translation line
\newcommand{\poltrans}[1]{%
  {\color{analysisgrey}\small\upshape\textbf{Translation:} #1}\par
  \vspace{0.5em}
...
\input{ch00_karta_tytulowa}

% Chapter 1
\input{ch01_jeszcze_jeden_pogrzeb}

% Subsequent chapters — uncomment as work progresses
% \input{ch02_ostatni_dzien_wakacji}
% \input{ch03_krolowa}
